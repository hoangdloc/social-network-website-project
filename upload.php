...
if (isset($_FILES['image']['name'])) {
  ...
  $uploaddir = $_SERVER['DOCUMENT_ROOT'] . '/social-network-website-project/assets/images/profile_pics';
  //Set File name	
...
if (isset($_POST['x'])) {
  ...
  $insert_pic_query = mysqli_query($con, "UPDATE tblUser SET profile_pic='$result_path' WHERE username='$userLoggedIn'");
