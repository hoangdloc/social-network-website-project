...
class User
{
	...
	public function getNumberOfFriendRequests()
	{
		...
		$query = mysqli_query($this->con, "SELECT * FROM tblFriendRequest WHERE user_to = '$username'");
	...
	{
		$username = $this->user['username'];
		$query = mysqli_query($this->con, "SELECT profile_pic FROM tblUser WHERE username = '$username'");
		$row = mysqli_fetch_array($query);
	...
	public function getMutualFriends($user_to_check)
	{
		...
		$query = mysqli_query($this->con, "SELECT friend_array FROM tblUser WHERE username='$user_to_check'");
		$row = mysqli_fetch_array($query);
