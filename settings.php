...
<div class="main_column column">
  ...
  <?php
  $user_data_query = mysqli_query($con, "SELECT first_name, last_name, email FROM tblUser WHERE username = '$userLoggedIn'");
  ...
  <form action="settings.php" method="POST">
    ...
    New Password Confirm: <input type="password" name="new_password_confirm" id="settings_input"><br>
